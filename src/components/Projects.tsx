...
const projects = [
  ...
  { image: null, title: "Healthcare Chatbot", description: "Building a hybrid Retrieval-Augmented Generation (RAG) pipeline for PCOS health-tech queries, utilizing fine-tuned BERT for semantic intent classification and GPT-3.5 via conversational chain prompting to deliver clinically contextualized, low-latency responses.
currently working on it", tags: ["BERT", "GPT-3.5", "NLP", "LLM" , "RAG"], color: "#FBD000", github: null },
];
