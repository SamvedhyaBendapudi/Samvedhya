...
import Image from "next/image";
  ...
  { image: null, title: "PCOS Chatbot Prototype", description: "Proof-of-concept chatbot using fine-tuned BERT and GPT-3.5 to answer PCOS-related queries, improving user engagement through LLM-based natural language understanding.", tags: ["BERT", "GPT-3.5", "NLP", "LLM"], color: "#FBD000", github: null },
  { image: null, title: "Healthcare Chatbot", description: "Engineering a PCOS-focused conversational AI using BERT-based intent classification and GPT-3.5 chain prompting within a Retrieval-Augmented Generation architecture.", tags: ["BERT", "GPT-3.5", "NLP", "LLM"], color: "#FBD000", github: null },
const clouds = [
